...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int newMoney = this.getAmount() + other.getCurrency().valueInThisCurrency(other.getAmount(), this.getCurrency());
	...
	public int compareTo(Object other) {
		...
		if( universalValue().intValue() == otherMoney.universalValue().intValue()){
			return 0;
		}else if( universalValue().intValue() < otherMoney.universalValue().intValue()){
			return -1;
		}else {
			return 1;
		}
